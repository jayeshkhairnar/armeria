...
import static com.ctrlshift.server.AbstractPathMapping.ensureAbsolutePath;
...
import com.ctrlshift.internal.DefaultValues;
import com.ctrlshift.server.annotation.ByteArrayRequestConverterFunction;
import com.ctrlshift.server.annotation.ConsumeType;
import com.ctrlshift.server.annotation.ConsumeTypes;
import com.ctrlshift.server.annotation.Decorator;
import com.ctrlshift.server.annotation.Delete;
import com.ctrlshift.server.annotation.ExceptionHandler;
import com.ctrlshift.server.annotation.ExceptionHandlerFunction;
import com.ctrlshift.server.annotation.Get;
import com.ctrlshift.server.annotation.Head;
import com.ctrlshift.server.annotation.JacksonRequestConverterFunction;
import com.ctrlshift.server.annotation.Options;
import com.ctrlshift.server.annotation.Order;
import com.ctrlshift.server.annotation.Patch;
import com.ctrlshift.server.annotation.Path;
import com.ctrlshift.server.annotation.Post;
import com.ctrlshift.server.annotation.ProduceType;
import com.ctrlshift.server.annotation.ProduceTypes;
import com.ctrlshift.server.annotation.Put;
import com.ctrlshift.server.annotation.RequestConverter;
import com.ctrlshift.server.annotation.RequestConverterFunction;
import com.ctrlshift.server.annotation.ResponseConverter;
import com.ctrlshift.server.annotation.ResponseConverterFunction;
import com.ctrlshift.server.annotation.StringRequestConverterFunction;
import com.ctrlshift.server.annotation.Trace;
